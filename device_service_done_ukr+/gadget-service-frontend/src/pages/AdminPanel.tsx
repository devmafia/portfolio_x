...
const AdminPanel: React.FC = () => {
  const { callRequests, fetchCalls, addCallRequest, updateCallRequest, removeCallRequest } = useCall();
  const { messages, fetchMessages, addMessage, updateMessage, removeMessage } = useMessage();
